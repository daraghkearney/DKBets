...
export const SPORTS: SportConfig[] = [
  {
    ...
    description:
      "Tournament and league analysis with live Bet365 props, 1v1 duels and context-backed builders.",
    gradient: "from-emerald-600/20 via-[#07090f] to-cyan-900/15",
    glow: "shadow-[0_0_80px_rgba(34,197,94,0.15)]",
    accent: "#22c55e",
    dataSource: "Live stats",
    competitions: [
      {
        id: "premier-league",
        ...
        description:
          "EPL props, underpriced gems, Bet365 builders and positional matchups.",
      ...
      },
      {
        ...
        description: "2026 tournament archive — redirects to Premier League.",
        tagline: "Ended · Archive",
        live: false,
        dataSource: "Archive",
        features: ["Bet365 builder", "1v1 matchups", "Lineups"],
        accent: "#22c55e",
        accentDim: "#14532d",
      },
      {
        ...
        description:
          "UCL props, underpriced gems, Bet365 builders and positional matchups.",
        tagline: "Live · Full data",
        live: true,
        dataSource: "Live stats",
        features: [
  ...
  },
  {
    ...
    description:
      "NBA stats pipeline — points, rebounds, assists, 3PM and defensive matchup edges with probability-backed builders.",
  ...
  },
  {
    ...
    description:
      "Distance suitability, course history, jockey/trainer form and tipster consensus from proven racing analysts.",
    gradient: "from-amber-500/20 via-[#07090f] to-emerald-900/10",
    glow: "shadow-[0_0_80px_rgba(251,191,36,0.12)]",
    accent: "#fbbf24",
    dataSource: "Live racecards",
    competitions: [
      {
        id: "todays-races",
        label: "Today's Races",
