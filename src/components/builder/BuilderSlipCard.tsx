    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="text-right">
          <p className="text-2xl font-black tabular text-accent">
            {slip.combinedFractional}
          </p>
          <p className="text-xs text-muted">
            {slip.combinedDecimal.toFixed(2)} decimal
          </p>
        </div>
      </div>
      ...
      <p className="mt-4 text-[11px] text-muted">
        Modelled from tournament + career H2H stats. Not affiliated with Bet365.
        Gamble responsibly.
      </p>
    </div>
  );
